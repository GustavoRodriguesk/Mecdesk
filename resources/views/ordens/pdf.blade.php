    ...
    <style>
        * {
        ...
        .total-label {
            ...
            text-transform: uppercase;
            width: 1080px;
            /* Força esta coluna a ocupar todo o espaço sobrando */
        }
        ...
        .total-valor {
            ...
            font-weight: bold;
            white-space: nowrap;
            /* Impede que o valor quebre de linha */
        }
...
<body>
    ...
    {{-- BANNER OS --}}
    <table class="os-banner" cellpadding="0" cellspacing="0" style="text-align:center;">
        <tr>
                    ...
                    <table class="two-col">
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="field-value">{{ $ordem->veiculo->marca }} {{ $ordem->veiculo->modelo }}
                                    ({{ $ordem->veiculo->ano }}) &#8212; {{ $ordem->veiculo->cor }}</div>
                                ...
                                @if ($ordem->veiculo->quilometragem)
                                    ...
                                    <div class="field-value-light">
                                        {{ number_format($ordem->veiculo->quilometragem, 0, ',', '.') }} km</div>
                                @endif
                            </td>
                        </tr>
                    </table>
    ...
    {{-- RODAPÉ --}}
    <div class="rodape">
        Documento gerado automaticamente pelo <span class="rodape-strong">MecDesk</span> &nbsp;&middot;&nbsp;
