        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden p-6">
            ...
            <form action="{{ route('pecas.update', $peca->id) }}" method="POST" class="space-y-5">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nome" value="{{ old('nome', $peca->nome) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        ...
                        <input type="text" name="codigo" value="{{ old('codigo', $peca->codigo) }}"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-150">
                        @error('codigo')
                            <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="valor_unitario"
                            value="{{ old('valor_unitario', $peca->valor_unitario) }}"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-150"
                            required>
