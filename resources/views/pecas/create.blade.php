        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden p-6">
            ...
            <form action="{{ route('pecas.store') }}" method="POST" class="space-y-5">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nome" value="{{ old('nome') }}" placeholder="Ex: Filtro de Óleo"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        ...
                        <input type="text" name="codigo" value="{{ old('codigo') }}" placeholder="Ex: FLT-123"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-150">
                        @error('codigo')
                            <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="valor_unitario" value="{{ old('valor_unitario') }}"
                            placeholder="0.00"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-150"
                            required>
