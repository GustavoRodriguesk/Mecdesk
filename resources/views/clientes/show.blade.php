        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden mb-6">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-gray-50 rounded-md p-4 border border-gray-100 md:col-span-3">
                    <span
                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Endereço</span>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                ...
                <a href="{{ route('veiculos.create', ['cliente' => $cliente->id]) }}"
                    class="inline-flex items-center gap-1.5 px-3 py-3 text-xs font-medium text-white bg-blue-700 hover:bg-blue-800 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
                ...
                @forelse($cliente->veiculos as $veiculo)
                    <div
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="shrink-0 inline-flex items-center bg-gray-100 justify-center h-8 w-8 rounded-full text-gray-500 shrink-0">
