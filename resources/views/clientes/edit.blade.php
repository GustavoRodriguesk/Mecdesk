            ...
            <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="3"
                        class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-150">{{ $cliente->endereco }}</textarea>
                </div>
