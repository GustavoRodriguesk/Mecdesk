    ...
    <div class="w-full">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('clientes.index') }}"
                class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden p-6">
            ...
            <form action="{{ route('clientes.store') }}" method="POST" class="space-y-5">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nome" placeholder="Ex: João da Silva" maxlength="50"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" id="cpf_cnpj" name="cpf_cnpj" placeholder="Apenas números" maxlength="18"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-150">
                    </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="email" name="email" placeholder="Ex: contato@email.com" maxlength="100"
                        class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-150">
                </div>
