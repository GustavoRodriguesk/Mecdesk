        ...
        <form method="POST" action="{{ route('register') }}" novalidate>
            ...
            <div class="auth-form-group">
                ...
                <div class="auth-input-wrap">
                    <input type="text" id="empresa" name="empresa"
                        class="auth-input {{ $errors->has('empresa') ? 'has-error' : '' }}" value="{{ old('empresa') }}"
                        placeholder="Nome da sua oficina" autofocus required>
                </div>
                @error('empresa')
            ...
            <div class="auth-form-group">
                ...
                <div class="auth-input-wrap">
                    ...
                    <input type="text" id="name" name="name"
                        class="auth-input {{ $errors->has('name') ? 'has-error' : '' }}" value="{{ old('name') }}"
            ...
            <div class="auth-form-group">
                ...
                <div class="auth-input-wrap">
                    ...
                    <input type="email" id="email" name="email"
                        class="auth-input {{ $errors->has('email') ? 'has-error' : '' }}" value="{{ old('email') }}"
                        placeholder="voce@exemplo.com.br" autocomplete="email" required>
                </div>
                @error('email')
                    <p class="auth-input-error">{{ $message }}</p>
                @enderror
            ...
            <div class="auth-form-group">
                ...
                <div class="auth-input-wrap">
                    <input type="text" id="telefone" name="telefone"
                        class="auth-input {{ $errors->has('telefone') ? 'has-error' : '' }}" value="{{ old('telefone') }}"
            ...
            <div class="auth-form-group">
                ...
                <div class="auth-input-wrap">
                    ...
                    <button type="button" class="auth-toggle-pwd" data-target="password"
            ...
            <div class="auth-form-group">
                ...
                <div class="auth-input-wrap">
                    ...
                    <button type="button" class="auth-toggle-pwd" data-target="password_confirmation"
                        aria-label="Mostrar/ocultar senha">
                        <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
