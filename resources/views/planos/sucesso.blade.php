<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div
            class="bg-white rounded-3xl shadow-sm border border-slate-200 p-8 sm:p-12 text-center relative overflow-hidden">
            ...
            <div
                class="relative z-10 bg-slate-50/80 border border-slate-200/80 rounded-2xl p-6 sm:p-8 max-w-lg mx-auto mb-10 text-left space-y-4 backdrop-blur-sm">
                <div class="flex items-center justify-between border-b border-slate-200/60 pb-4">
                    <div>
                        <span class="text-xs uppercase font-extrabold tracking-wider text-slate-400">Empresa /
                            Oficina</span>
            ...
            <div class="relative z-10 border-t border-slate-100 pt-8 mb-10">
                <h3 class="text-xs font-bold uppercase tracking-wider text-slate-400 mb-6">Três passos simples para
                    começar:</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-left max-w-3xl mx-auto">
                    ...
                    <div class="p-4 rounded-xl bg-slate-50 border border-slate-100 space-y-2">
                        <div
                            class="w-8 h-8 rounded-lg bg-blue-100 text-blue-600 font-black flex items-center justify-center text-sm">
                            1</div>
                        <h4 class="font-bold text-slate-900 text-sm">Cadastre Clientes</h4>
                        <p class="text-xs text-slate-500 leading-relaxed">Adicione seus clientes e vincule os veículos
                            com placa, marca e modelo.</p>
                    </div>

                    {{-- Passo 2 --}}
                    <div class="p-4 rounded-xl bg-slate-50 border border-slate-100 space-y-2">
                        <div
                            class="w-8 h-8 rounded-lg bg-indigo-100 text-indigo-600 font-black flex items-center justify-center text-sm">
                            2</div>
                        <h4 class="font-bold text-slate-900 text-sm">Catálogo de Serviços</h4>
                        <p class="text-xs text-slate-500 leading-relaxed">Cadastre sua tabela de mão de obra e peças com
                            preço e estoque.</p>
                    </div>
                    ...
                    <div class="p-4 rounded-xl bg-slate-50 border border-slate-100 space-y-2">
                        <div
                            class="w-8 h-8 rounded-lg bg-emerald-100 text-emerald-600 font-black flex items-center justify-center text-sm">
                            3</div>
                        <h4 class="font-bold text-slate-900 text-sm">Abra a 1ª Ordem</h4>
                        <p class="text-xs text-slate-500 leading-relaxed">Gere orçamentos e envie o link de aprovação
                            direta pelo celular do cliente.</p>
                    </div>
                </div>
            </div>
