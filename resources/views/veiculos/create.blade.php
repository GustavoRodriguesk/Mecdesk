            ...
            <form action="{{ route('veiculos.store') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="modelo" placeholder="Ex: Onix 1.0"
                    ...
                    <div>
                        ...
                        <input type="text" name="cor" placeholder="Ex: Prata"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-150">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="quilometragem" placeholder="Ex: 50000"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-150">
                    </div>
                </div>
